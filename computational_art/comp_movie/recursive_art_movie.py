...
def build_random_function(min_depth, max_depth):
    """ Builds a random function of depth at least min_depth and depth
        ...
        returns: the randomly generated function represented as a nested list
                 ...
                 these functions)
    """
    ops = ['x', 'y', 't', 'prod', 'avg', 'cos_pi', 'sin_pi', 'cos_7', 'fun_func']
    if max_depth <= 0:
        ops = ops[:3]
    elif min_depth > 0:
        ops = ops[3:]
...
def evaluate_random_function(f, x, y, t):
    ...
    if f[0] == 'x':
        ...
        return math.cos(7.*evaluate_random_function(f[1], x, y, t))
    elif f[0] == 'prod':
...
def generate_art(x_size=350, y_size=350):
    ...
    green_function = build_random_function(5, 8)
